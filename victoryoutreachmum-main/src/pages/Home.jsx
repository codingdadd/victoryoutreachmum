      ...
      <section className="py-16 bg-gradient-to-br from-gray-50 to-blue-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-5xl font-bold bg-gradient-to-r from-blue-300 via-blue-500 to-blue-700 bg-clip-text text-transparent mb-8">Join Us for This Sunday Church!</h2>
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div className="flex items-center space-x-4">
                  ...
                  <div className="text-left">
                    ...
                    <p className="text-gray-600">D N Nagar Municipal School, Madhuban Colony,<br />D.N. Nagar, Andheri West, Mumbai, Maharashtra 400058</p>
                  </div>
                </div>
                <div className="flex items-center space-x-4">
                  ...
                  <div className="text-left">
                    ...
                    <p className="text-gray-600">Morning 7:00 AM</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="py-16 bg-gradient-to-br from-blue-50 via-white to-green-50 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              to="/contact"
              className="bg-gradient-to-r from-blue-500 to-green-500 text-white px-8 py-3 rounded-2xl font-semibold shadow-[8px_8px_16px_rgba(0,0,0,0.15),-8px_-8px_16px_rgba(255,255,255,0.7)] hover:shadow-[4px_4px_8px_rgba(0,0,0,0.2),-4px_-4px_8px_rgba(255,255,255,0.8)] transition-all duration-300 transform hover:scale-105"
            >
