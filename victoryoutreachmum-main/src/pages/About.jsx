  ...
  const leadership = [
    {
      ...
      role: 'Senior Pastor',
      bio: 'Pastor Samson has been leading Victory Outreach Mumbai for over 20 years, bringing passion for evangelism and discipleship to the community.',
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
      ...
      <div>
        <img
          ...
          className="rounded-2xl shadow-lg w-full object-cover h-96 md:h-[500px]"
        />
      </div>
