...
const Contact = () => {
  ...
  const contactInfo = [
    ...
    },
    {
      icon: Phone,
      title: 'Phone',
      details: ['(+91) 98765-43210', 'Emergency: (+91) 87654-32109'],
      color: 'green'
    },
    {
      icon: Mail,
      title: 'Email',
      details: ['info@victoryoutreachmumbai.org', 'pastor@victoryoutreachmumbai.org'],
      color: 'purple'
    },
    {
      icon: Clock,
      title: 'Service Times',
      details: ['Sunday: 7:00 AM', 'Wednesday: 7:00 PM', 'Friday: 6:30 PM'],
      color: 'yellow'
    }
  ];
